 ...
 * @propert {string} address1
 * @propert {string} city
 * @propert {string} country
 * @propert {string} first_name
 * @propert {string} last_name
 * @propert {string} phone
 * @propert {string} province
 * @propert {string} zip
 * @propert {string} province_code
 * @propert {string} country_code
 * @propert {boolean} default
 */
